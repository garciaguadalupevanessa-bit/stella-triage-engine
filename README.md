...
1. Clone repository / Clonar repositorio:
   `git clone https://github.com/garciaguadalupevanessa-bit/stella-triage-engine.git`

2. Install dependencies / Instalar dependencias:
   `pip install -r requirements.txt`

3. Seed database / Poblar base de datos sintética:
   `python seed_data.py`

4. Run FastAPI server / Ejecutar servidor FastAPI:
...
- **Database Engine / Motor:** SQLite / PostgreSQL via SQLAlchemy
